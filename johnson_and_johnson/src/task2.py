...
# 2. What’s the total downtime (in minutes) recorded?
...
duckdb.sql("SELECT round(avg(downtime_min), 2) as avg_downtime_per_event FROM 'data/maintenance_events.csv'").show()
